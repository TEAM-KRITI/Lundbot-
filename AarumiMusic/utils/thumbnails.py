...
async def get_thumb(videoid: str) -> str:
    ...
    try:
        title_font = ImageFont.truetype("AarumiMusic/assets/font2.ttf", 30)
        meta_font = ImageFont.truetype("AarumiMusic/assets/font.ttf", 22)
        ...
        if is_live:
            live_font = ImageFont.truetype("AarumiMusic/assets/font2.ttf", 22)
    ...
    try:
        ...
        draw.text((30, 20), "IG: @riteshcoder", fill="yellow", font=wm_font)

        # DEV watermark (top-right)
        dev_text = "DEV: @BADNAMBOTS"
